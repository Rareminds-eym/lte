...
CREATE TYPE IF NOT EXISTS public.xp_category AS ENUM ('evidence', 'engagement');

CREATE TYPE IF NOT EXISTS public.xp_event_type AS ENUM (
...
CREATE INDEX IF NOT EXISTS idx_xp_org_user ON public.xp_events(org_id, user_id);
