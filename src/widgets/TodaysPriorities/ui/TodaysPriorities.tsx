...
export const TodaysPriorities: React.FC<TodaysPrioritiesProps> = ({ data }) => {
  return (
    <div className="bg-surface-primary rounded-2xl border border-line-default p-6 shadow-xs flex flex-col justify-between h-full">
      <div>
        {/* Header */}
        <div className="flex flex-wrap items-center justify-between pb-4 border-b border-line-default mb-4 gap-2">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-bold text-content-primary">Today's Priorities</h2>
          </div>
            ...
            return (
              <div key={item.id} className="flex items-start justify-between group cursor-pointer">
                ...
                <div className="text-right shrink-0 pt-0.5 flex flex-col items-end gap-1">
                  <div className="flex items-center gap-1 text-[11px] text-content-secondary font-medium">
                    <svg
                      aria-hidden="true"
                  ...
                  <div className="text-[11px] font-extrabold text-brand-600">
                    +{item.xpReward} XP
                  </div>
                </div>
              </div>
      ...
      {/* Footer */}
      <div className="pt-5 border-t border-line-default mt-5 text-center">
        <a
          href="#tasks"
