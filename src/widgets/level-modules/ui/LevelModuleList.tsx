...
export const LevelModuleList: React.FC<LevelModuleListProps> = ({
  ...
  return (
    <div className="w-full mt-10 space-y-8">
      ...
      {!hasModules && (
        <div className="rounded-3xl border border-line-default bg-surface-primary p-6 sm:p-8 text-center shadow-2xs">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-50 text-brand-600">
            <BookOpenIcon className="h-6 w-6" />
          </div>
          <h4 className="mt-4 text-lg font-bold text-content-primary">No modules available</h4>
          <p className="mx-auto mt-2 max-w-xl text-sm font-medium leading-6 text-content-muted">
            Modules have not been added to this level yet.
          </p>
        </div>
      )}
