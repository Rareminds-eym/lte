    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
        ...
        <div className="lg:col-span-5 border border-brand-200/80 rounded-2xl p-5 bg-level-working-bg/40 flex flex-col items-center justify-between text-center min-h-[330px]">
          ...
          <div className="relative w-full max-w-[245px] h-[220px] my-3 flex flex-col items-center justify-center -space-y-6">
            {/* Top Hexagon: Backend Engineering (Selected Dark Blue Node) */}
            <div
              className={`w-28 h-28 bg-brand-600 text-white flex flex-col items-center justify-center cursor-pointer hover:bg-brand-700 transition-colors z-10 ${hexClip}`}
            >
              ...
              <div className="text-[10px] font-semibold italic text-brand-100 mt-1">45% Match</div>
            </div>
            ...
            <div className="flex items-start justify-center gap-0.5 z-0">
              ...
              <div className="relative w-28 h-28 group cursor-pointer">
                ...
                >
                  ...
                  <div className="text-[10px] font-bold leading-tight text-content-primary max-w-[72px]">
              ...
              <div className="relative w-28 h-28 group cursor-pointer">
                ...
                >
                  ...
                  <div className="text-[9px] font-medium text-content-muted mt-1">Explore Path</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-7 border border-line-default/90 rounded-2xl p-5 bg-surface-primary flex flex-col justify-between space-y-4">
          <p className="text-xs sm:text-[13px] text-content-body leading-relaxed font-medium">
            {data.description}
          </p>
