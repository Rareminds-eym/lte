      ...
      <div className="relative z-10 space-y-6 max-w-[640px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <div className="text-[10px] text-content-on-dark-muted font-medium">Capability</div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <div className="text-[10px] text-content-on-dark-muted font-medium">Output</div>
              <div className="text-sm font-semibold text-content-inverse mt-0.5 leading-snug">
                {data.output}
              </div>
            </div>
