  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex justify-center max-w-xl mx-auto">
        <div className="relative flex items-center w-full bg-white/80 rounded-full px-4 py-2.5 border border-slate-300 shadow-2xs hover:border-slate-400 focus-within:bg-white focus-within:ring-2 focus-within:ring-brand-500/20 focus-within:border-brand-600 transition-all">
