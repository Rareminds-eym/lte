import type { LteStageName } from "@functions/shared/lte-stages";
...
export interface ModuleStageContent {
  ...
  curriculumReference: Record<string, unknown> | null;
  items: EContentItem[];
...
export interface ModuleContentRow {
  ...
  curriculum_reference: Record<string, unknown> | null;
  is_active: boolean;
