 ...
 *   - the server builds it with `gatewayResponse(...)` (functions/api/v1/internal/skillpassport)
 *   - the caller parses it with `GatewayEnvelopeSchema` (functions/lib/gateway/skill-gateway.ts,
